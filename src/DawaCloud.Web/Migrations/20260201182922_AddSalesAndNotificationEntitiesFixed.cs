...
{
    /// <inheritdoc />
    public partial class AddSalesAndNotificationEntitiesFixed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowStockThresholdDays = table.Column<int>(type: "int", nullable: false),
                    ExpiryAlertDays30 = table.Column<int>(type: "int", nullable: false),
                    ExpiryAlertDays60 = table.Column<int>(type: "int", nullable: false),
                    ExpiryAlertDays90 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrugRequestId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoodsReceipts_DrugRequests_DrugRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPrescriptionItems = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RetailSales_CashierShifts_CashierShiftId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GoodsReceiptItems_Drugs_DrugId",
                        column: x => x.DrugId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quotations_WholesaleCustomers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WholesaleSales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WholesaleSales_WholesaleCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "WholesaleCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrescriptionItem = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RetailSaleItems_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RetailSaleItems_Drugs_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Drugs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RetailSaleItems_RetailSales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuotationItems_Drugs_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Drugs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WholesaleSaleId = table.Column<int>(type: "int", nullable: true),
                    RetailSaleId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_RetailSales_RetailSaleId",
                        column: x => x.RetailSaleId,
                        principalTable: "RetailSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_WholesaleSales_WholesaleSaleId",
                        column: x => x.WholesaleSaleId,
                        principalTable: "WholesaleSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "WholesaleSaleItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WholesaleSaleItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WholesaleSaleItems_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WholesaleSaleItems_Drugs_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Drugs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WholesaleSaleItems_WholesaleSales_SaleId",
                        column: x => x.SaleId,
                        principalTable: "WholesaleSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceiptItems_DrugId",
                table: "GoodsReceiptItems",
                column: "DrugId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceipts_DrugRequestId",
                table: "GoodsReceipts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_RetailSaleId",
                table: "Payments",
                column: "RetailSaleId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_WholesaleSaleId",
                table: "Payments",
                column: "WholesaleSaleId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationItems_DrugId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RetailSaleItems_BatchId",
                table: "RetailSaleItems",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailSaleItems_DrugId",
                table: "RetailSaleItems",
                column: "DrugId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailSaleItems_SaleId",
                table: "RetailSaleItems",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailSales_CashierShiftId",
                table: "RetailSales",
                column: "CashierShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_WholesaleSaleItems_BatchId",
                table: "WholesaleSaleItems",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_WholesaleSaleItems_DrugId",
                table: "WholesaleSaleItems",
                column: "DrugId");

            migrationBuilder.CreateIndex(
                name: "IX_WholesaleSaleItems_SaleId",
                table: "WholesaleSaleItems",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_WholesaleSales_CustomerId",
